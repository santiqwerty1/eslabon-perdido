...
|---|---|---|---|---|---|---|---|---|---|---|---|
| C-001 | FIX-Beta pertenece a FIX-Alfa | FIX-Beta | miembro_de | FIX-Alfa | expresa | S01 §2.1 | consenso amplio | alta |  | resuelta | vigente |
| C-002 | FIX-Gamma pertenece a FIX-Alfa | FIX-Gamma | miembro_de | FIX-Alfa | expresa | S99 fig. 3 | bastante aceptada | media | topología sensible al modelo de heterogeneidad composicional | sin resolver | vigente |
...
| C-004 | La posición de FIX-Gamma es incompatible entre C-002 y C-003 | C-002 | incompatible_con | C-003 | sintesis | S02 fig. 3 | no evaluado | desconocida | derivada de dos filas del propio registro | sin resolver | vigente |
