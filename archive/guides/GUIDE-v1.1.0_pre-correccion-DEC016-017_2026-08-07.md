...
| `OPEN-015` | Licencia de datos, código y contenido | Fases 0–1 |
...
- DEC-018 y DEC-032 permanecen como decisiones supersedidas;
...
| `DEC-016` | DECIDIDO | El Atlas es la primera superficie compartida, integrada desde el primer lanzamiento. |
| `DEC-017` | RETENIDO | Modo Reconstrucción completo; reubicado a campañas con evidencia adecuada. |
...
Las decisiones `DEC-033` a `DEC-048` no invalidan la arquitectura `DEC-001` a `DEC-031`. Cambian:
